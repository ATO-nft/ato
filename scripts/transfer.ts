...
async function main() {
  ...
  const nftContractAddress = "0x02eadE8b6466E0d68578918d3e4c6C0C03f8D6Ff" // replace with your own nft contract address
  ...
  const ato = new ethers.Contract(nftContractAddress, atoAbi, issuer)
  console.log("Issuer address: " + issuer.address)
  const transfer = await ato.transferFrom(issuer.address, friend.address, 1)
